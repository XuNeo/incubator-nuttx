...
/* This describes the state of the T113-S3 UART6 port. */

#ifdef CONFIG_T113_UART6
static struct up_dev_s g_uart6priv =
{
  .uartbase       = T113_UART_VADDR(6),
...
/* This describes the state of the T113-S3 UART7 port. */

#ifdef CONFIG_T113_UART7
static struct up_dev_s g_uart7priv =
{
  .uartbase       = T113_UART_VADDR(7),
...
#    define UART5_ASSIGNED      1
#  elif defined(CONFIG_T113_UART6)
#    define TTYS0_DEV           g_uart6port /* UART6 is ttyS0 */
#    define UART6_ASSIGNED      1
#  elif defined(CONFIG_T113_UART7)
...
#  define UART5_ASSIGNED      1
#elif defined(CONFIG_T113_UART6) && !defined(UART6_ASSIGNED)
#  define TTYS1_DEV           g_uart6port /* UART6 is ttyS1 */
#  define UART6_ASSIGNED      1
#elif defined(CONFIG_T113_UART7) && !defined(UART7_ASSIGNED)
...
#if defined(CONFIG_T113_UART5) && !defined(UART5_ASSIGNED)
...
#if defined(CONFIG_T113_UART6) && !defined(UART6_ASSIGNED)
...
/****************************************************************************
 * Name: t113_uart0config, uart1config, uart2config, ..., uart7config
 *
 * Description:
 *   Configure the UART
 *
...
#ifdef CONFIG_T113_UART6
static inline void t113_uart6config(void)
{
  irqstate_t flags;
...
#ifdef CONFIG_T113_UART7
static inline void t113_uart7config(void)
{
  irqstate_t flags;
